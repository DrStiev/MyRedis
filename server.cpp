...
// the handling is split into try_one_request(). If there is not enough data, it will do nothing until a future loop iteration
...
static void handle_write(Conn *conn) {
    ...
    if (conn->outgoing.size() == 0) { // all data is written. Step 2: Written 1 response
